...
در داشبورد انتخاب می‌کند. OWNER می‌تواند تأمین‌کنندگان سازمان را ایجاد، ویرایش
و بدون حذف تاریخی غیرفعال کند و OPERATOR فهرست و جزئیات را ببیند. بک‌اند فایل‌ها
را به ساختار استاندارد تبدیل می‌کند و
...
مدیریت تأمین‌کنندگان پس از ورود در http://localhost:3000/suppliers در دسترس است.
...
- docs/SPRINT_PLAN_FA.md: برنامه اسپرینت‌های محصول، فیچرها و مسیر یادگیری
